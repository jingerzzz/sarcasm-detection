## v9: Use doc2vec to extract feature instead of BOW, Tfidf
...
FNAME = "output_v9_data_size={}.txt".format(len(data))
...
train_tagged = train.apply(lambda r: TaggedDocument(words=tokenize_text(r['comment']), tags=[r.is_sarcastic]), axis=1)
test_tagged = test.apply(lambda r: TaggedDocument(words=tokenize_text(r['comment']), tags=[r.is_sarcastic]), axis=1)
