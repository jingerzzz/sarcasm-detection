## v6: add directly comment and parent_comment directly as the feature
...
for i in range(len(data)):
    df.loc[i,"comment"]=df.loc[i,"comment"]+" "+df.loc[i,"parent_comment"]


FNAME = "output_v6_data_size={}.txt".format(len(data))
