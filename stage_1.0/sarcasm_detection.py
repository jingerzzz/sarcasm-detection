...
df = train_df[25001:30000]
data_size = len(df)


FNAME = "output_data_size={}.txt".format(data_size)
...
tfidf = TfidfVectorizer(sublinear_tf = True, min_df=5, norm = 'l2', 
                        encoding = 'latin-1', ngram_range=(gram_n_1,gram_n_2), stop_words='english')
output_file.write("ngram_range:({},{})\n".format(gram_n_1,gram_n_2))
